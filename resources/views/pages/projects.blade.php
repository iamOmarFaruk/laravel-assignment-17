                ...
                <div class="card overflow-hidden shadow rounded-4 border-0 mb-5">
                    <div class="card-body p-0">
                        <div class="d-flex align-items-center">
                            ...
                            <img class="img-fluid" src="https://dummyimage.com/300x400/343a40/6c757d" alt="Project 1" />
                        </div>
                    </div>
                </div>
                <div class="card overflow-hidden shadow rounded-4 border-0">
                    <div class="card-body p-0">
                        <div class="d-flex align-items-center">
                            ...
                            <img class="img-fluid" src="https://dummyimage.com/300x400/343a40/6c757d" alt="Project 2" />
                        </div>
                    </div>
                </div>
            </div>
